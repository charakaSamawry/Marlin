...
#define STRING_CONFIG_H_AUTHOR "(thisiskeithb-BTT SKR Mini E3v2, CharakaSamawry)" // Who made the changes.
 ...
 *                                      X, Y, Z, E0 [, E1[, E2...]]
 */
#define DEFAULT_MAX_ACCELERATION      { 3000, 3000, 200, 7500 }
...
/**
 * Default Acceleration change(s) = mm/s^2
 * Override with M204
 *
 *   M204 P    Acceleration
...
#define MANUAL_PROBE_START_Z 0.32
...
// Travel limits (mm) after homing, corresponding to endstop positions. (??Not that important ccan be set from printer..)
#define X_MIN_POS 0    // [                                                ]
#define Y_MIN_POS 0    // [Home offsets - Corresponding to endstop position]
#define Z_MIN_POS 0    // [            Can be set from screen..            ]
...
#define NOZZLE_PARK_FEATURE
  ...
  // Specify a park position as { X, Y, Z_raise } //(mm?)
...
//#define PASSWORD_FEATURE
  ...
  #define PASSWORD_LENGTH      6            // (#) Number of digits (1-9). 3 or 4 is recommended
